...
- [ ] Add synchronized scenery stairs and ladders. Preserve independent same-map elevation travel where the destination remains on the loaded map; use the coordinated all-player boundary for cross-map destinations.
